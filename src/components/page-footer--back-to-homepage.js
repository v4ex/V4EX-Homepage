...
const PageFooterComponent = () => {
  return (
    <div style={pageFooterStyles}>
      ...
      <p style={copyrightStyles}><a href="https://github.com/v4ex/www.v4ex.com/tree/v1.0"><FontAwesomeIcon icon={["fab", "github"]} /></a> Copyright &copy; {new Date().getFullYear()} V4EX Inc.</p>
    </div>
  )
}
